...
class XetraSourceConfig(NamedTuple):
    ...
    src_col_start_price: column name for starting proce in source
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_traded_vol: column name for daily traded volumne in target
    trg_col_ch_prev_clos: column name for change to previous day's closing price
